...
function Footer() {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-[#212121] px-8 pb-3 pt-2">
      <div className="flex-1 text-left">
        <p className="font-kanit text-white font-light">
          Made with <span className="text-[#f7588a]">❤</span> by dulapahv
        </p>
      </div>
